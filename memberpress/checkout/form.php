    ...
    <?php else: ?>
      ...
      <?php if(!$mepr_options->username_is_email): ?>
        <div class="mp-form-row mepr_username">
          ...
          <p class="username-instruction"><span style="font-size: 80%;">Si vous inscrivez un établissement (en tant que référant de cet établissement), pour faciliter la gestion du compte, merci de choisir comme identifiant le nom de l'établissement</span></p>
        </div>
      <?php endif; ?>
