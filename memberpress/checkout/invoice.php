  ...
  <table class="mp-table">
    ...
    <tbody>
      <?php foreach( $invoice['items'] as $item ): ?>
        <tr>
          ...
          <?php endif; ?>
          <td class="mp-currency-cell"><?php echo 'à partir de ' . MeprAppHelper::format_currency($item['amount'], true, false); ?></td>
        </tr>
      <?php endforeach; ?>
    ...
    <tfoot>
      ...
      <tr>
        ...
        <th class="mp-currency-cell"><?php echo 'à partir de ' . MeprAppHelper::format_currency($total, true, false); ?></th>
      </tr>
    </tfoot>
  </table>
</div>
